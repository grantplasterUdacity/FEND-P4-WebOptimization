...
var pizzaElementGenerator = function(i) {
  ...
  // Create elements to be appended to the DOM
  ...
  // Set style at the end to improve performance
...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    // Determines the percent size of the screen that the elements will take up
    if (size === "1") {
      newsize = 25;
    }
    else if (size === "2") {
    ...
    // Batch setting of the style to improve performance
...
function updatePositions(scrollTop) {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    items[i].scrollMove = items[i].basicLeft + 100 * phase;
  }

  // Move the pizza elements
  for (var i = 0; i < items.length; i++) {
